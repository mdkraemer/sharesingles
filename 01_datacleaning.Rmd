...
ac012 <- ac %>% select(mergeid, ac012_)
...
an implausible amoount of 0 values. I would recommend to use thinc2, which does
...
data4 <- inner_join(data3, ac012, by="mergeid")
